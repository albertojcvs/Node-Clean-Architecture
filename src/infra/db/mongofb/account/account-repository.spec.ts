...
describe('Account mongo repository', () => {
  ...
  describe('add()', () => {
    test('Should update the account acessToken on updateAccessToken', async () => {
      const sut = makeSut()
  ...
  describe('loadByToken()', () => {
    ...
    test('Should return an account if user is admin on loadByToken if user is a admin', async () => {
      const sut = makeSut()
      await accountCollection.insertOne({
        name: 'any_name',
        email: 'any_email@mail.com',
